...
from kc.data_structures.equivalenceclasses import EquivalenceClass, VariableEquivalenceClass, EquivalenceClasses
from kc.data_structures.nnf import NNFNode, ExtensionalNode, IntensionalNode, AndNode, OrNode, ForAllNode, ExistsNode
from kc.data_structures.substitutions import Substitution
